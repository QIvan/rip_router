 ...
 *  
 *  It has been AutoGen-ed  December 22, 2012 at 11:19:00 PM by AutoGen 5.12
 ...
 *  by the test_server author or copyright holder.  AutoOpts is
...
/* * * * * *
 *
 *  Enumeration of test_server exit codes
 */
typedef enum {
    TEST_SERVER_EXIT_SUCCESS = 0,
    TEST_SERVER_EXIT_FAILURE = 1
} test_server_exit_code_t;
/* * * * * *
 *
